...
export default function Settings() {
  ...
  return (
    <div style={{ fontFamily: 'system-ui, -apple-system, Segoe UI, Roboto, sans-serif', padding: 24, maxWidth: 720, margin: '0 auto' }}>
      <h1>Settings</h1>
      <p>Configure your math practice session.</p>
      ...
      <div style={{ marginTop: 24, display: 'flex', gap: 12 }}>
        <button onClick={saveSettings} style={{ fontSize: 18, padding: '8px 16px' }}>Save Settings</button>
        <button onClick={() => navigate('/')} style={{ fontSize: 18, padding: '8px 16px', backgroundColor: '#f8f9fa', border: '1px solid #dee2e6' }}>Cancel</button>
      </div>
    </div>
  );
}
